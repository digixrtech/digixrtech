...
![Six dimensions of review design decision flow — from error type through prompt technique, orchestration, critique approach, evaluation method, to cost-stakes calibration](/images/insights/the-reviewer-paradox/dimension-decision-flow.png)
...
![Review strategy decision tree — self-critique for visible errors, CoVe for factual verification, multi-agent debate for adversarial pressure, separate judge for domain compliance](/images/insights/the-reviewer-paradox/review-decision-tree.png)
